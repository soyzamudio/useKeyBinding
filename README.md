...
The React demo imports the hook directly from `src` and includes a command menu, live shortcut counter, input protection controls, and a short getting-started guide.
